...
async def start(message: Message):
    await message.answer(
        "👨‍🍳🍰 Привет! Добро пожаловать к двум шефам.\n\n"
        "Здесь живут сотни рецептов — от сочного\n"
        "стейка до нежного десерта.\n\n"
        "Один обожает мясо и сытные блюда.\n"
        "Второй без ума от десертов и лёгкой кухни.\n\n"
        "И оба согласны в одном —\n"
        "еда должна быть вкусной, точной и простой.\n\n"
        "Поэтому создали бота где есть всё сразу.\n\n"
        "Готовы? Напиши что приготовить сегодня 👇",
